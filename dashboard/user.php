...
<body>
    ...
    <div class="container py-5">
        <div class="dashboard-header">
            ...
            <p>Selamat datang di dashboard user. Anda dapat melihat jadwal pengajian dan melakukan absen di sini.</p>
        </div>
            ...
            <div class="col-md-6">
                <div class="card dashboard-card">
                    <div class="card-body">
                        ...
                        <a href="/UAS/dashboard/absensi.php" class="btn btn-primary btn-dashboard">Absen Pengajian</a>
                    </div>
                </div>
            </div>
        </div>
